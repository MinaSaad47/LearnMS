...
function CourseCard({ course }: { course: Course }) {
  return (
    <Card className='bg-white/70  border-color2 border-[3px] w-full h-full relative hover:bg-zinc-300 transition-all duration-300 hover:scale-125 hover:cursor-pointer'>
