...
public class Student : User
{
    ...
    public static Student Register(Account account, string fullName, string phoneNumber, string parentPhoneNumber, string studentCode, string schoolName, StudentLevel level)
    {
        var id = Guid.NewGuid();
