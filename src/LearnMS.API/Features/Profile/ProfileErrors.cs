...
public static class ProfileErrors
{
    ...
    public static readonly ApiError InsufficientCredits = new("profile/insufficient-credits", "Insufficient credits please contact 0122 234 3492", StatusCodes.Status400BadRequest);
}